const CACHE='pavese-v1';
const ASSETS=[
  "../../pwa-common/gbprof-accessibility.css?v=1",
  "../../pwa-common/gbprof-accessibility.js?v=1",
  "../../privacy.html",
  "../../accessibilita.html",'./','./index.html','./styles.css','./hero-photo.css','./content.js','./app.js','./manifest.webmanifest','./icons/icon.svg','./assets/images/hero-pavese.png','./maps/01-mondo.svg','./maps/02-fratture.svg','./maps/03-immagine.svg','./maps/04-poetica.svg','./maps/05-opere.svg','./maps/06-conclusione.svg','./maps/sintesi.svg'];
