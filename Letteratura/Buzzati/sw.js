const CACHE = "buzzati-gbprof-v1";
const ASSETS = [
  "../../pwa-common/gbprof-accessibility.css?v=1",
  "../../pwa-common/gbprof-accessibility.js?v=1",
  "../../privacy.html",
  "../../accessibilita.html",
  "./", "./index.html", "./styles.css", "./hero-photo.css", "./content.js", "./app.js", "./manifest.webmanifest", "./icons/icon.svg", "./assets/images/hero-buzzati.png",
