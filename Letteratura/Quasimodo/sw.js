...
const ASSETS=['./','./index.html','./styles.css','./content.js','./app.js','./manifest.webmanifest','./icons/icon.svg','./maps/01-mondo.svg','./maps/02-fratture.svg','./maps/03-immagine.svg','./maps/04-poetica.svg','./maps/05-opere.svg','./maps/06-conclusione.svg','./maps/sintesi.svg'];
